...
extension GestureRecognizer {
    ...
    /// multiarray input to make a prediction. See GestureRecognizer.mlmodel >
    /// Predictions
    ///
    /// The `keypointsMultiArray()` method of a `VNHumanBodyHandGestureObservation`
    ...
    func calculatePredictionWindowSize() -> Int {
        ...
        let frameRate = GestureRecognizer.frameRate
